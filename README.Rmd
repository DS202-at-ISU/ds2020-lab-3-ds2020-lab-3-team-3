...
-   My statement to verify: I counted 89 total deaths --- some unlucky Avengersare basically meat loaf with an E-Z Pass.
...
-   I filtered the deaths dataset based on the Death column having a 'YES'. Then I counted the number of rows to get 89 deaths in total, which matches with what the article originally mentioned.
